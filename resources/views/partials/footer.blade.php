            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <ul class="footer-links" style="list-style: none; padding: 0;">
                        ...
                        <li class="mb-2">
                            <a href="#produk" style="color: rgba(255,255,255,0.9); text-decoration: none; transition: color 0.3s ease; display: flex; align-items: center;" onmouseover="this.style.color='var(--primary-orange)'" onmouseout="this.style.color='rgba(255,255,255,0.9)'">
                                <i class="fas fa-chevron-right me-2" style="font-size: 0.8rem;"></i>
                                Produk
                            </a>
                        </li>
