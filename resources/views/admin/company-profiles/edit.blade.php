            ...
            <form action="{{ route('admin.company-profiles.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="operational_hours" name="operational_hours" rows="5" placeholder="Enter operational hours">{{ old('operational_hours', $profile->operational_hours) }}</textarea>
