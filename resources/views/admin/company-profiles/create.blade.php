            ...
            <form action="{{ route('admin.company-profiles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control" id="email_desc" name="email_desc" value="{{ old('email_desc') }}" placeholder="e.g. Untuk penawaran & dokumen resmi">
                                @error('email_desc')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control" id="phone_desc" name="phone_desc" value="{{ old('phone_desc') }}" placeholder="e.g. Senin-Jumat, 08.00-17.00">
                                @error('phone_desc')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="whatsapp_desc" name="whatsapp_desc" value="{{ old('whatsapp_desc') }}" placeholder="e.g. Respon cepat dalam 2 jam">
                        @error('whatsapp_desc')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
