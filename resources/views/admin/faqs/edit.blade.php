            ...
            <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="answer" name="answer" rows="6" required>{{ old('answer', $faq->answer) }}</textarea>
                        @error('answer')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" id="order" name="order" value="{{ old('order', $faq->order) }}">
                                @error('order')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-warning float-right">Update FAQ</button>
                </div>
            </form>
        </div>
    </div>
